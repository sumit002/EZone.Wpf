...
namespace ElectronicZone.Wpf.View.Master
{
    ...
    {
        PurchaseViewModel vm = new PurchaseViewModel(DialogCoordinator.Instance);
        ...
        //            folderFields.Add("PurchaseDate", (DateTime.Parse(dpPurchaseDate.Text).ToString(ConfigurationManager.AppSettings["DateTimeFormat"])));
